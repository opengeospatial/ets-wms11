...
mvn install
cd target 
unzip ets-wms11-1.1.1-r8.zip -d $TE_BASE/scripts/
...
echo "  "
echo "TEAM Engine ($te_tag) and the ets-wms11-1.1.1-r8 have been installed."
echo "  "
echo " UNIX/OS users - You can run the test with the following commands: "
echo "   export TE_BASE=$TE_BASE"
echo "   $base/teamengine/te_install/bin/unix/test.sh -source=wms/1.1.1/ctl/wms.xml"
echo "  "
echo " Windows users - You can run the test with the following commands:"
echo "   set TE_BASE=$TE_BASE"
echo "   $base/teamengine/te_install/bin/windows/test.bat -source=wms/1.1.1/ctl/wms.xml"
echo "  "
